...
ShaderProgram.prototype.setUniform1f = function( unif, x)
{
	gl.uniform1f( this.uniformLocations[ unif ], x );
};
ShaderProgram.prototype.setUniform3f = function( unif, x, y, z )
{
	gl.uniform3f( this.uniformLocations[ unif ], x, y, z );
};
ShaderProgram.prototype.setUniformMat3 = function( unif, mat )
{
	gl.uniformMatrix3fv( this.uniformLocations[ unif ], false, mat );
};
